...
if(typeof define==='function'&&define.amd&&define.amd.jQuery){define(['jquery'],setup)}else{setup(jQuery)}})();urlParam=function(name,def_value){if(def_value==null)
def_value='';var results=new RegExp('[\\?&]'+name+'=([^&#]*)').exec(window.location.href);if(results==null){return def_value}else{return results[1]||def_value}};showPreloader=function(){$.blockUI({message:'<svg width="80px" height="80px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="uil-default"><rect x="0" y="0" width="100" height="100" fill="none" class="bk"></rect><rect  x="46.5" y="40" width="7" height="20" rx="5" ry="5" fill="#fff" transform="rotate(0 50 50) translate(0 -30)">  <animate attributeName="opacity" from="1" to="0" dur="1s" begin="0s" repeatCount="indefinite"/></rect><rect  x="46.5" y="40" width="7" height="20" rx="5" ry="5" fill="#fff" transform="rotate(32.72727272727273 50 50) translate(0 -30)">  <animate attributeName="opacity" from="1" to="0" dur="1s" begin="0.09090909090909091s" repeatCount="indefinite"/></rect><rect  x="46.5" y="40" width="7" height="20" rx="5" ry="5" fill="#fff" transform="rotate(65.45454545454545 50 50) translate(0 -30)">  <animate attributeName="opacity" from="1" to="0" dur="1s" begin="0.18181818181818182s" repeatCount="indefinite"/></rect><rect  x="46.5" y="40" width="7" height="20" rx="5" ry="5" fill="#fff" transform="rotate(98.18181818181819 50 50) translate(0 -30)">  <animate attributeName="opacity" from="1" to="0" dur="1s" begin="0.2727272727272727s" repeatCount="indefinite"/></rect><rect  x="46.5" y="40" width="7" height="20" rx="5" ry="5" fill="#fff" transform="rotate(130.9090909090909 50 50) translate(0 -30)">  <animate attributeName="opacity" from="1" to="0" dur="1s" begin="0.36363636363636365s" repeatCount="indefinite"/></rect><rect  x="46.5" y="40" width="7" height="20" rx="5" ry="5" fill="#fff" transform="rotate(163.63636363636363 50 50) translate(0 -30)">  <animate attributeName="opacity" from="1" to="0" dur="1s" begin="0.45454545454545453s" repeatCount="indefinite"/></rect><rect  x="46.5" y="40" width="7" height="20" rx="5" ry="5" fill="#fff" transform="rotate(196.36363636363637 50 50) translate(0 -30)">  <animate attributeName="opacity" from="1" to="0" dur="1s" begin="0.5454545454545454s" repeatCount="indefinite"/></rect><rect  x="46.5" y="40" width="7" height="20" rx="5" ry="5" fill="#fff" transform="rotate(229.0909090909091 50 50) translate(0 -30)">  <animate attributeName="opacity" from="1" to="0" dur="1s" begin="0.6363636363636364s" repeatCount="indefinite"/></rect><rect  x="46.5" y="40" width="7" height="20" rx="5" ry="5" fill="#fff" transform="rotate(261.8181818181818 50 50) translate(0 -30)">  <animate attributeName="opacity" from="1" to="0" dur="1s" begin="0.7272727272727273s" repeatCount="indefinite"/></rect><rect  x="46.5" y="40" width="7" height="20" rx="5" ry="5" fill="#fff" transform="rotate(294.54545454545456 50 50) translate(0 -30)">  <animate attributeName="opacity" from="1" to="0" dur="1s" begin="0.8181818181818182s" repeatCount="indefinite"/></rect><rect  x="46.5" y="40" width="7" height="20" rx="5" ry="5" fill="#fff" transform="rotate(327.27272727272725 50 50) translate(0 -30)">  <animate attributeName="opacity" from="1" to="0" dur="1s" begin="0.9090909090909091s" repeatCount="indefinite"/></rect></svg>',overlayCSS:{backgroundColor:'#000',opacity:'0.8',},css:{applyPlatformOpacityRules:!1,backgroundColor:'transparent',border:'none',top:($(window).height()-80)/2+'px',left:($(window).width()-80)/2+'px',width:'80px',height:'80px','z-index':19992}})}
hidePreloader=function(){$.unblockUI()};formatPrice=function(sum){return String(sum).replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g,'$1 ')};function morphWords(count,rules){response={word:"",count:""};words=rules.split('|');if((count%10)==1&&count!=11){response.word=words[0];response.count=count}
if((count%10)>=2&&(count%10)<=4){response.word=words[1];response.count=count}
if(((count%10)>=5||(count%10)==0)||(count>=11&&count<=14)){response.word=words[2];response.count=count}
return response}
toggleVidgetActivity=function(elt){var elt_id=$(elt).attr('data-elt-id');var field_name=$(elt).attr('data-field-name');$.ajax({dataType:'json',cache:!1,url:'/udata/data/toggleVidgetActivity/'+elt_id+'/'+field_name+'/.json'})};reachMetrikaGoal=function(goal){var metrika_counter=$('body').attr('data-metrika-counter');window[metrika_counter].reachGoal(goal)};initAjaxList=function(params){var config=$(params.config_id);if(typeof config!=='undefined'){var url=config.data('url');var total=parseInt(config.data('total'));var per_page=parseInt(config.data('per-page'));var p=parseInt(config.data('p'));var wrapper=config.data('wrapper');if(typeof params.wrapper==='undefined'){wrapper=$(params.config_id)}else{wrapper=params.wrapper}
var sort_field='';if(typeof config.data('sort-field')!=='undefined'){sort_field='&sort_field='+config.data('sort-field')}else{sort_field=''}
var sort_order='';if(typeof config.data('sort-order')!=='undefined'){sort_order='&sort_order='+config.data('sort-order')}
var additional_params='';if(typeof config.data('additional-params')!=='undefined'){var additional_params=$.param(config.data('additional-params'));if(additional_params.length){additional_params='&'+additional_params}}
var async=1;if(typeof params.async!=='undefined'){async=params.async}
var show_preloader=1;if(typeof params.show_preloader!=='undefined'){show_preloader=params.show_preloader}
var url_params='p='+p+'&per_page='+per_page+sort_field+sort_order+additional_params;if(show_preloader){showPreloader()}
$.ajax({dataType:'html',async:async,url:url+'&'+url_params,success:function(response){response=$('<div/>').append(response);var new_total=parseInt(response.find('#total').text());if(!isNaN(new_total)){total=new_total;$(config).data('total',total);response.find('#total').remove()}
response=response.html();if(params.replace>=0){if(params.replace){$(wrapper).html(response)}else{$(wrapper).append(response)}}
if(typeof params.change_url!=='undefined'&&params.change_url){var link=[location.protocol,'//',location.host,location.pathname].join('')+'?'+url_params;if(typeof window.history.pushState!=='undefined'){window.history.pushState(null,null,link)}}
if(show_preloader){hidePreloader()}
switch(typeof params.callback){case 'function':return params.callback(total,per_page,p,response);case 'string':return window[params.callback](total,per_page,p,response)}},error:function(a,b,c){if(show_preloader){hidePreloader()}}})}};initAjaxFilters=function(params){var category_id=parseInt(params.category_id);var type_id='';if(typeof params.type_id!=='undefined'){type_id=parseInt(params.type_id)}
var group_names='';if(typeof params.group_names!=='undefined'){group_names=parseInt(params.group_names)}
var cache_hours=0;if(typeof params.cache_hours!=='undefined'){cache_hours=parseInt(params.cache_hours)}
var filter_params='';if(typeof params.filter_params!=='undefined'){filter_params=params.filter_params}
var template='modules/_ajax/catalog/filters.xsl';if(typeof params.template!=='undefined'){template=params.template}
var show_preloader=1;if(typeof params.show_preloader!=='undefined'){show_preloader=params.show_preloader}
if(typeof params.wrapper!=='undefined'&&$(params.wrapper).length){if(show_preloader){showPreloader()}
$.ajax({dataType:'html',url:'/udata/catalog/getFilters/'+category_id+'/'+type_id+'/'+group_names+'/'+cache_hours+'/?transform='+template+'&category_id='+category_id+'&'+filter_params,success:function(response){$(params.wrapper).html(response);var filterParams=$.deparam(filter_params);if(show_preloader){hidePreloader()}
switch(typeof params.callback){case 'function':return params.callback(filterParams);case 'string':return window[params.callback](filterParams)}},error:function(a,b,c){if(show_preloader){hidePreloader()}}})}};manipulateWithCart=function(action,item,onSuccess){var url='';if(action!='remove_all'){switch(action){case 'add':url='basket/put/element/'+item.element_id+'/.json?amount='+item.amount+'&'+item.params;break;case 'modify':url='modifyCartItem/'+item.id+'/'+item.amount+'/.json';break;case 'remove':case 'delete':url='basket/remove/item/'+item.id+'/.json';break}}else{url='basket/remove_all/.json'}
if(url.length){$.ajax({url:'/udata/emarket/'+url,dataType:'json',success:function(response){return onSuccess(response)}})}}
$(document).ready(function(){if($('[data-modify = "morph"]').length){$('[data-modify = "morph"]').each(function(){var count=$(this).attr("data-count");var rules=$(this).attr("data-rules");var wCont=$(this).attr("data-word-container");var cCont=$(this).attr("data-number-container");var noCount=$(this).attr("data-option");modifed=morphWords(count,rules);if(wCont!=undefined&&cCont!=undefined){$("'"+wCont+"'").html(modifed.word);if(noCount===undefined){$("'"+cCont+"'").html(modifed.count)}}else $(this).html(((noCount===undefined)?modifed.count+" ":"")+modifed.word)})}
$('body').on('submit','#form-login',function(){$('#form-login').ajaxSubmit({dataType:'json',success:function(response){if(response.result){location.reload()}else{var errors="Вы указали неверный e-mail/пароль, или ваш аккаунт еще не активирован";$('#form-login .form-group').each(function(){$(this).removeClass('has-success')});document.getElementById('form-login').reset();alert(errors)}}});return!1});$('body').on('submit','#form-forget',function(){$('#form-forget').ajaxSubmit({dataType:'json',success:function(response){if(response.result){location.href='/forget_do/'}else{var errors="При восстановления пароля возникли ошибки:\r\n";$.each(response.errors,function(i,v){errors+=v+"\r\n"});alert(errors)}}});return!1})});function checkValue(element){var $element=$(element);if($element.val().length>0){$element.addClass('-has-value')}else{$element.removeClass('-has-value')}}
jQuery(document).ready(function(global){var App=exportApp;$('.nav_city .nav_city').on('click',function(){$(this).closest('.nav_top').toggleClass('open')});$('.nav_city_menu > ul li').on('click',function(){var id=$(this).data('id');if(id){showPreloader();$.ajax({dataType:'html',url:'/udata/content/changeCity/'+id+'/.json',success:function(response){location.reload()},error:function(){hidePreloader()}})}});if($('.nav_city_item').data('is-confirmed')=='0'){$('#city-confirm').show();App.modules.Popups.open('city-confirm')}
$('body').on('click','#city-confirm .btn',function(){if($(this).data('popup-closer')){$('body,html').animate({scrollTop:0},0);$('.nav_city .nav_city').trigger('click')}else{var id=$(this).data('id');if(id){showPreloader();$.ajax({dataType:'html',url:'/udata/content/changeCity/'+id+'/.json',success:function(response){location.reload()},error:function(){hidePreloader()}})}}});var links_position=$(window).innerHeight()/2;$('.header_about__link.-left').css({"top":links_position,});$('.header_about__link.-right').css({"top":links_position,});$(document).on('resize',function(){$('.header_about__link.-left').css({"top":links_position,});$('.header_about__link.-right').css({"top":links_position,})});var scrollTopContainer=$('[scroll-to-top]');$(window).scroll(function(){if($(this).scrollTop()>$(window).height()*0.3){scrollTopContainer.fadeIn()}else{scrollTopContainer.fadeOut()}});scrollTopContainer.click(function(e){e.preventDefault();$('body,html').animate({scrollTop:0},400)});$.ajaxSetup({cache:!1});if($('[data-mobile-overlay]')){var mobile_overlay=$('[data-mobile-overlay]');var dont_show_again=parseInt(mobile_overlay.data('popup-dont-show'));if(!dont_show_again||!$.cookie('first_in')){if(dont_show_again){$.cookie('first_in',1,{domain:'',path:'/'})}
var show_interval=parseFloat(mobile_overlay.data('popup-show-interval'));if(!show_interval){show_interval=0.35}
var hide_interval=parseInt(mobile_overlay.data('popup-hide-interval'))*1000;var $mobileOverlay=$('[data-mobile-overlay]');TweenMax.fromTo($mobileOverlay.show(),0.75,{alpha:0,scale:0.85},{alpha:1,scale:1,delay:show_interval,force3D:!0});$mobileOverlay.find('.js-close-mobile').click(function(e){e.preventDefault();$mobileOverlay.nope().fadeOut(function(){$mobileOverlay.remove()})});if(hide_interval){setTimeout(function(){$mobileOverlay.nope().fadeOut(function(){$mobileOverlay.remove()})},parseFloat(hide_interval+parseFloat(show_interval*1000)))}}}
$('.slick-track .news_title, slick-track .news_text, .archive_article__title, .docs_name').dotdotdot({watch:!0});$('body').on('change','select[name="reports_category"]',function(){var id=$(this).val();if(id){$('.reports-wrap div').each(function(){$(this).addClass('hide')});$('.report_'+id).removeClass('hide')}
return!1});$('body').on('submit','.webform',function(){var form_id=$(this).attr('id');var current_popup=$(this).data('popup');if($(this).find('#acceptterms').length){if(!$(this).find('#acceptterms').prop('checked')){alert('Для продолжение необходимо согласиться с правилами.');return!1}}
showPreloader();$(this).ajaxSubmit({dataType:'json',success:function(response){if(response.result){hidePreloader();App.modules.Popups.close(current_popup);$('#feedback-complete .popup_title').html(response.posted_message);$('#feedback-complete').show();App.modules.Popups.open('feedback-complete');$('#'+form_id+' .input-group_label, #'+form_id+' .btn_label').each(function(){$(this).removeClass('error')});$('#'+form_id+' .valid').each(function(){$(this).removeClass('valid')});document.getElementById(form_id).reset()}else{hidePreloader();var errors="При отправке возникли ошибки:\r\n";$.each(response.errors,function(i,v){errors+=v+"\r\n"});alert(errors)}},error:function(){hidePreloader()}});return!1});if($('input.phone').length>0){$('input.phone').each(function(){$(this).mask("+7(999)-999-99-99")})}
$('body').on('click','.captcha-reset',function(){var d=new Date();$('.captcha-img').each(function(){$(this).attr('src','/captcha.php?reset&'+d.getTime())})});$(".header_menu ul li").hover(function(){var h_m_p=$(this).children('a').find('i.material-icons.cae-plus');var h_m_m=$(this).children('a').find('i.material-icons.cae-minus');h_m_p.click(function(){console.log("hide: +");console.log("show: -");$(this).hide();h_m_m.show();$(this).parents('li').addClass('active');$(this).parents('li').find('ul').addClass('-opened')});h_m_m.click(function(){console.log("hide: -");console.log("show: +");$(this).hide();h_m_p.show();$(this).parents('li').removeClass('active');$(this).parents('li').find('ul').removeClass('-opened')})});$('body').on('click','.ajaxform',function(){var id=parseInt($(this).data('id'));var header=$(this).data('header');var page_name=$(this).data('page-name');var reciever_id=$(this).data('reciever-id');if(!reciever_id){reciever_id=0}
if(id){showPreloader();$.ajax({dataType:'html',url:'/udata/data/getCreateForm/'+id+'?transform=modules/_ajax/webforms/form.xsl&id='+id+'&form_header='+header+'&page_name='+page_name+'&reciever_id='+reciever_id,success:function(response){hidePreloader();$('.ajaxform-wrap').html(response);App.modules.Validations.init();App.modules.Selects.init();if(id==178){App.modules.Slides.init();App.modules.Pagination.init();App.modules.Datapicker.init()}
$('.phone').mask("+7(999)-999-99-99");App.modules.Popups.open('form-'+id+'-ajax')},error:function(){hidePreloader()}})}
return!1});$('body').on('click','.ajaxloaded-form span[data-popup-closer], .master_card-popup span[data-popup-closer]',function(){App.modules.Popups.close($(this).data('id'));return!1});$('body').on('click','.btn-card-constructor',function(){var id=$(this).data('id');var obj_id=$(this).data('obj-id');var page_name=$(this).data('page-name');if(id){showPreloader();$.ajax({dataType:'html',url:'/udata/content/getCardsInfo/'+id+'?transform=modules/_ajax/content/card.constructor.xsl&obj_id='+obj_id+'&page_name='+page_name,success:function(response){hidePreloader();$('.cardmaster-wrap').html(response);App.modules.Popups.open('form-cardmaster');App.modules.ReserveCard.init();App.modules.Selects.init();App.modules.Validations.init();$('.phone').mask("+7(999)-999-99-99");$('input[name="data[new][system]"]:first').trigger('change')},error:function(){hidePreloader()}})}
return!1});$('body').on('change','.deposit-nav',function(){var id=$(this).val();if(id){$('.deposit-mobile-wrap .visible-sm[data-toggle-id!="'+id+'"]').addClass('hide');$('.deposit-mobile-wrap .visible-sm[data-toggle-id="'+id+'"]').removeClass('hide')}
return!1});$('body').on('change','.deposit-nav-mobile',function(){var id=$(this).val();if(id){$(this).parent().parent().parent().find('table').addClass('hide');$(this).parent().parent().parent().find('table[data-pos="'+id+'"]').removeClass('hide')}});$('body').on('change','.deposit-calc-table-mobile-nav',function(){var pos=$(this).val();$(this).parent().parent().parent().find('.table-mobile').addClass('hide');$(this).parent().parent().parent().find('.deposit-calc-table-mobile-'+pos).removeClass('hide')});$('body').on('click','div[data-show-more] .btn-more',function(){if($(this).data('open-block')){$(this).html("Подробнее<i class='material-icons'>keyboard_arrow_down</i>");$(this).data('open-block',!1);$(this).find('.material-icons').text('keyboard_arrow_down');var $close=$(this).parent().find('div');$($close).slideUp()}else{$(this).html("Скрыть<i class='material-icons'>keyboard_arrow_up</i>");$(this).find('.material-icons').text('keyboard_arrow_up');$(this).data('open-block',!0);var $open=$(this).parent().find('div');$($open).slideDown()}
return!1});$('body').on('click','[data-popup-video]',function(){var video_code=$(this).data('popup-video');var content='<iframe width="100%" height="100%" src="https://www.youtube.com/embed/'+video_code+'?autoplay=1" frameborder="0" allowfullscreen autoplay></iframe>';$('.video-popup-wrap').html(content);App.modules.Popups.open('video_popup');return!1});$('body').on('click','.video-popup .popup_close',function(){App.modules.Popups.close('video_popup');$('.video-popup-wrap').html('');return!1});$('body').on('click','.deposit_table_custom .deposit_value.js-toggle li',function(){var cnt=$(this).data('toggle');if(cnt){var name=$(this).data('name');var short_descr=$(this).data('short-descr');$(this).parent().parent().parent().find('.deposit_name span').text(name);$(this).parent().parent().parent().find('.deposit_des').text(short_descr);$(this).parent().parent().parent().find('div.-deposite').addClass('-hide');$(this).parent().parent().parent().find('[data-toggle-id="'+cnt+'"]').removeClass('-hide');$(this).parent().parent().parent().find('[data-toggle-id="'+cnt+'"] tbody:first').css('display','table-row-group')}});var countCategory=$('.ncl-inner .news_category-item').length;if(countCategory>4){var openerCategoryList=$('.news-category_list-opener');openerCategoryList.show();openerCategoryList.click(function(){$('#news_category').toggleClass('open')})}
if($('.recaptcha').length>0){setTimeout(function(){$('.recaptcha').each(function(){var this_=this;if(typeof grecaptcha!=='undefined'){grecaptcha.render(this_,{'sitekey':'6LfzfT0UAAAAANLkEa-DPQ6QHDySSkvJPTOwNW18'})}})},500)}
if($('.slider_rules').length){if(!$('.slider_rules').find('.js-slider-item').length){$('.slider_rules').remove()}}
$('.slider-image.js-slider-deposit .slick-dots').css({'left':'0','right':'0','text-align':'center','bottom':'7%'});$('.multiple-items').slick({dots:!0,arrows:!1,infinite:!0,slidesToShow:4,slidesToScroll:1,autoplay:!1,autoplaySpeed:2000,responsive:[{breakpoint:1200,settings:{slidesToShow:3,slidesToScroll:1,infinite:!0,}},{breakpoint:992,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:768,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1}}]});$('.responsive').slick({dots:!1,infinite:!0,speed:300,slidesToShow:4,slidesToScroll:1,autoplay:!1,autoplaySpeed:2000,responsive:[{breakpoint:1200,settings:{slidesToShow:3,slidesToScroll:1,infinite:!0,}},{breakpoint:992,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:768,settings:{slidesToShow:2,slidesToScroll:1}}]})});$(function(){;function height_header_resize(){var
height_header=$('.header_about').height(),window_height=$(window).height(),window_width=$(window).width();$('.header_about__top, .header_about__image, .header, .header_menu,  .header_about, .header-main').css('min-height',window_height-100);if(window_width<=767){$('.header_menu').css('min-height','auto')}}
height_header_resize();$(window).load(function(){height_header_resize()});$(window).resize(function(){height_header_resize()})});$(function(){$(".header_menu ul li").hover(function(){var t=$(this).children("a").find("i.material-icons.cae-plus"),a=$(this).children("a").find("i.material-icons.cae-minus");t.click(function(){console.log("hide: +"),console.log("show: -"),$(this).hide(),a.show().animate({scrollTop:$(a).offset().top},1100),$(this).parents("li").addClass("active"),$(this).parents("li").find("ul").addClass("-opened")}),a.click(function(){console.log("hide: -"),console.log("show: +"),$(this).hide(),t.show().animate({scrollTop:$(t).offset().top},1100),$(this).parents("li").removeClass("active"),$(this).parents("li").find("ul").removeClass("-opened")})});var t=1;$("div.header_menu>ul>li").each(function(a,e){a<8?$(this).attr({"data-step":t,"data-show":"show"}):(a%8==0&&t++,$(this).attr({"data-step":t,"data-show":"hide"}))}),t<=1&&$("#step_next").attr("data-go",""),$("#step_prev").click(function(t){$("#step_prev").attr("data-go")&&(go_prev=$("#step_prev").attr("data-go"),"1"==go_prev?($('div.header_menu>ul>li[data-show="show"]').attr("data-show","hide"),$('div.header_menu>ul>li[data-step="'+go_prev+'"]').attr("data-show","show"),$("#step_prev").attr("data-go",""),$("#step_next").attr("data-go",+go_prev+1)):($('div.header_menu>ul>li[data-show="show"]').attr("data-show","hide"),$('div.header_menu>ul>li[data-step="'+go_prev+'"]').attr("data-show","show"),$("#step_prev").attr("data-go",+go_prev-1),$("#step_next").attr("data-go",+go_prev+1)))}),$("#step_next").click(function(a){$("#step_next").attr("data-go")&&(go_next=$("#step_next").attr("data-go"),+go_next+1<t?($('div.header_menu>ul>li[data-show="show"]').attr("data-show","hide"),$('div.header_menu>ul>li[data-step="'+go_next+'"]').attr("data-show","show"),$("#step_prev").attr("data-go",+go_next-1),$("#step_next").attr("data-go",+go_next+1)):($('div.header_menu>ul>li[data-show="show"]').attr("data-show","hide"),$('div.header_menu>ul>li[data-step="'+go_next+'"]').attr("data-show","show"),$("#step_prev").attr("data-go",+go_next-1),$("#step_next").attr("data-go","")))})});(function($){$.fn.extend({BlackAndWhite:function(customOptions){'use strict';var $el=this,options=$.extend({hoverEffect:!0,webworkerPath:!1,invertHoverEffect:!1,speed:500,onImageReady:null,intensity:1,crossOrigin:!0},customOptions),hoverEffect=options.hoverEffect,webworkerPath=options.webworkerPath,invertHoverEffect=options.invertHoverEffect,intensity=(typeof options.intensity==='number'&&options.intensity<1&&options.intensity>0)?options.intensity:1,fadeSpeedIn=$.isPlainObject(options.speed)?options.speed.fadeIn:options.speed,fadeSpeedOut=$.isPlainObject(options.speed)?options.speed.fadeOut:options.speed,$window=$(window),_evtNamespace='.BlackAndWhite',_isIE7=(document.all&&!window.opera&&window.XMLHttpRequest)?!0:!1,_browserPrefixes=' -webkit- -moz- -o- -ms- '.split(' '),_cssPrefixString={},_cssPrefix=function(property){if(_cssPrefixString[property]||_cssPrefixString[property]===''){return _cssPrefixString[property]+property}
...
return property.toLowerCase()},_cssfilters=(function(){var el=document.createElement('div');el.style.cssText=_browserPrefixes.join('filter'+':blur(2px); ');return!!el.style.length&&((document.documentMode===undefined||document.documentMode>9))}()),_supportsCanvas=!!document.createElement('canvas').getContext,_supportWebworker=(function(){return(typeof(Worker)!=='undefined')?!0:!1}()),_cssFilter=_cssPrefix('Filter'),_imagesArray=[],_webWorker=_supportWebworker&&webworkerPath?new Worker(webworkerPath+'BnWWorker.js'):!1,_onMouseLeave=function(e){$(e.currentTarget).find('.BWfade').stop(!0,!0).animate({opacity:invertHoverEffect?0:1},fadeSpeedOut)},_onMouseEnter=function(e){$(e.currentTarget).find('.BWfade').stop(!0,!0).animate({opacity:invertHoverEffect?1:0},fadeSpeedIn)},_onImageReady=function(img){if(typeof options.onImageReady==='function'){options.onImageReady(img)}},_initWebworker=function(imagesToLoadlength){if(_webWorker&&_supportsCanvas&&!_cssfilters&&!imagesToLoadlength){_webWorkerLoop()}},_webWorkerLoop=function(){if(!_imagesArray.length){if(_webWorker.terminate){_webWorker.terminate()}
...
_injectTags($img,$imageWrapper);$img.data('_b&w_loaded',!0);imagesToLoadlength--;_initWebworker(imagesToLoadlength)}).load()}else{imagesToLoadlength--;_injectTags($img,$imageWrapper)}
$img.data('_b&w',!0)});_initWebworker(imagesToLoadlength);if(hoverEffect){$el.unbind(_evtNamespace).on('mouseleave'+_evtNamespace,_onMouseLeave).on('mouseenter'+_evtNamespace,_onMouseEnter)}
if(_supportsCanvas&&!_cssfilters){$window.unbind(_evtNamespace).on('resize'+_evtNamespace+' orientationchange'+_evtNamespace,_resizeCanvases)}};var destroy=function(){$el.off(_evtNamespace);$window.off(_evtNamespace)};_init();return{destroy:destroy}}})}(jQuery));$('.bwWrapper').css({'display':'block','position':'relative'});$('.slider-box .multiple-items .box-slide .box-logo img').css('opacity','1');$(function(){$('.bwWrapper').BlackAndWhite({hoverEffect:!0,webworkerPath:!1,onImageReady:function(img){$(img).parent().animate({opacity:1})}})});(function(){setTimeout(function(){$('.slider-image').slick('unslick');$('.slider-image').slick({slidesToShow:1,slidesToScroll:1,dots:!0,autoplay:!0,pauseOnHover:!1,pauseOnFocus:!1,autoplaySpeed:5000})},100)})();window.addEventListener("DOMContentLoaded",function(){var nodes=document.querySelectorAll(".parent");[].forEach.call(nodes,function(tr){var box=[],next=tr.nextElementSibling;while(next&&next.classList.contains("box")){box.push(next);next=next.nextElementSibling}
tr.cells[0].addEventListener("click",function(){box.forEach(function(item){item.classList.toggle("show")});return!1})})});$(document).ready(function(){$('tr.parent').click(function(){$(this).toggleClass('opener')})});(function(){function onResize(){var tbl=document.querySelector("table");var size=tbl.getBoundingClientRect();var top=size.top;var bottom=size.bottom;var thead=tbl.querySelector("thead");var hhead=thead?thead.getBoundingClientRect().height:0;var tfoot=tbl.querySelector("tfoot");var hfoot=tfoot?tfoot.getBoundingClientRect().height:0;var tcapt=tbl.querySelector("caption");var hcapt=tcapt?tcapt.getBoundingClientRect().height:0;if(getComputedStyle(tbl).captionSide.match("bottom"))bottom-=hcapt;else top+=hcapt;var tfrst=tbl.querySelector("tbody>tr:first-child");var hfrst=tfrst?tfrst.getBoundingClientRect().height:0;var tlast=tbl.querySelector("tbody>tr:last-child");var hlast=tlast?tlast.getBoundingClientRect().height:0;function onScroll(){var dY=window.pageYOffset;if(thead&&dY>top&&dY<bottom){var ey=bottom-hfoot-hhead-hlast;if(dY>ey)dY=ey;thead.style.transform="translate(0,"+(dY-top-1)+"px)"}else{thead.style.transform="inherit"}
var h=window.innerHeight;if(tfoot&&dY+h<bottom&&dY<bottom){dY+=h-bottom;var ay=top+hhead+hfrst+hfoot-bottom;if(dY<ay)dY=ay;tfoot.style.transform="translate(0,"+(dY+1)+"px)"}else{tfoot.style.transform="inherit"}};window.removeEventListener("scroll",onScroll);onScroll();window.addEventListener("scroll",onScroll)};onResize();window.addEventListener("resize",onResize)})();function FixTable(table){var inst=this;this.table=table;$('tr > th',$(this.table)).each(function(index){var div_fixed=$('<div/>').addClass('fixtable-fixed');var div_relat=$('<div/>').addClass('fixtable-relative');div_fixed.html($(this).html());div_relat.html($(this).html());$(this).html('').append(div_fixed).append(div_relat);$(div_fixed).hide()});this.StyleColumns();this.FixColumns();$(window).scroll(function(){inst.FixColumns()}).resize(function(){inst.StyleColumns()})}
FixTable.prototype.StyleColumns=function(){var inst=this;$('tr > th',$(this.table)).each(function(){var div_relat=$('div.fixtable-relative',$(this));var th=$(div_relat).parent('th');$('div.fixtable-fixed',$(this)).css({'width':$(th).outerWidth(!0)-parseInt($(th).css('border-left-width'))+'px','height':$(th).outerHeight(!0)+'px','left':$(div_relat).offset().left-parseInt($(th).css('padding-left'))+'px','padding-top':$(div_relat).offset().top-$(inst.table).offset().top+'px','padding-left':$(th).css('padding-left'),'padding-right':$(th).css('padding-right')})})}
FixTable.prototype.FixColumns=function(){var inst=this;var show=!1;var s_top=$(window).scrollTop();var h_top=$(inst.table).offset().top;if(s_top<(h_top+$(inst.table).height()-$(inst.table).find('.fixtable-fixed').outerHeight())&&s_top>h_top){show=!0}
$('tr > th > div.fixtable-fixed',$(this.table)).each(function(){show?$(this).show():$(this).hide()})}
$(document).ready(function(){$('.fixtable').each(function(){new FixTable(this)})});jQuery(document).ready(function(){var tableOffset=jQuery("#table-1").offset().top;var jQueryheader=jQuery("#table-1 > thead").clone();var jQueryfixedHeader=jQuery("#header-fixed").append(jQueryheader);var bottable=jQuery("a#close").offset().top;jQuery("#header-fixed").width(jQuery("#table-1").width());jQuery(window).bind("scroll",function(){var offset=jQuery(this).scrollTop();if(offset>=tableOffset&&jQueryfixedHeader.is(":hidden")&&offset<bottable){jQueryfixedHeader.show()}else if(offset<tableOffset||offset>bottable){jQueryfixedHeader.hide()}
jQuery("#header-fixed td").each(function(index){jQuery(this).width(function(){return jQuery("#table-1 td").eq(index).width()})})})})